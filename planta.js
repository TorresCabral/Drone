...
class Planta{
    constructor(h, Ts, tc, td, x, k, u, m, g, l, kf, Iz, tal, Fg, phi_max, w_max, Fc_max, Tc_max, correct) {
 ...
 function GetToPoint(self) {
    return self.correct
 }

 function SetToPoint(self, sp) {
    self.correct = sp
 }
 
 function rk4(self, tk, h, xk, uk) {
 ...
 function GsxCs(self, r_)//G(s)*c(s) {
